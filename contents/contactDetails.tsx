  ...
  return (
    <div className='contact'>
      <ul>
        ...
        <li className='social'><a href={'mailto:abdulrahmanahmedrasheed@gmail.com'} target={"_blank"} rel={"noreferrer"}><Image className='social-image' src={mail} alt="Picture of the author" width={36.03} height={36.03}/><span className='details'>abdulrahmanahmedrasheed@gmail.com</span></a></li>
